  ...
  return (
    <div className="border border-background/10 overflow-hidden">
      <div className="px-6 py-4 border-b border-background/10 flex items-center justify-between">
        ...
        <span className="text-xs font-mono text-background/40">tributary-credit-loop.ts</span>
      </div>
      ...
      <div className="px-6 py-4 border-t border-background/10 flex items-center gap-3">
        <span className="w-2 h-2 rounded-full bg-background/60 animate-pulse" />
        <span className="text-xs font-mono text-background/40">Arc testnet</span>
      </div>
    </div>
  );
}
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="mb-16 lg:mb-24">
          ...
          >
            Three steps.
            <br />
            <span className="text-background/50">Nobody has to be trusted.</span>
          </h2>
        </div>
            ...
            {STEPS.map((step, i) => (
              ...
              >
                <div className="flex items-start gap-6">
                  <span className="font-display text-3xl text-background/30">{step.numeral}</span>
